...
[Route("v1/categories")]
[ApiController] // Facilita na criação de endpoints
public class CategoryController : ControllerBase
{
    [HttpGet]
    [Route("")]// Responde a GET
    [AllowAnonymous]
...

    {
        ...
        {
            return BadRequest(new { Mensage = "Não foi possível criar a Categoria " });
        }
    }
